          ...
          <div className='row align-items-center'>
            ...
            <div className='col-7'>
              <div className='input-group'>
                <input className='form-control py-1' placeholder='Your Email Address' type="text" aria-label='Your Email Address' aria-describedby='basic-addon2' />
          ...
          <div className='row'>
            <div className='col-4'>
              ...
              <div>
                ...
                <a href="tel:+91 8264954234" className='mt-3 d-block mb-1 text-white'>+91 826495423</a>
                <a href="mailto:navdeepdahiya753@gmail.com" className='mt-2 d-block mb-0 text-white'>navdeepdahiya753@gmail.com</a>
